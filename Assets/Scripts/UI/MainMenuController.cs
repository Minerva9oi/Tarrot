...
namespace Tarot.UI
{
    public sealed class MainMenuController : MonoBehaviour
    {
        ...
        {
            new("每日运势", "Daily reading selected."),
            new("牌阵占卜", "Spread reading selected."),
            new("占卜日记", "Journal selected."),
            new("设置", "Settings selected."),
            new("退出", "Quit selected.")
        };
        ...
        private void CreateMenuButtons(Transform parent)
        {
            ...
            for (var index = 0; index < MenuItems.Length; index++)
            {
                ...
                var button = CreateButton(parent, item.Label, () => Debug.Log(item.LogMessage));
        ...
        {
            public MenuItem(string label, string logMessage)
            {
                Label = label;
